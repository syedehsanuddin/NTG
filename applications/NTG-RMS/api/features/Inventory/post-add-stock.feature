...
Feature: Add stock (Purchase Entry)
  ...
  Scenario: POST Add stock (Purchase Entry) returns successful response
    When I send a POST request to endpoint "postAddStock" with payload '{"ingredientId":"{STORED_INGREDIENT_ID}","quantity":1,"unitCost":1,"branchId":"bcf7f7a6-f6a2-474a-8bb9-2ccf10a26191","supplierName":"Automatest Test Ingredient ","invoiceNumber":"Automatest Test Ingredient ","reason":"Automatest Test Ingredient ","transactionDate":"2026-01-01T10:13:47.470Z"}' and headers "language=en"
    Then the response status should be 201
