...
Feature: Support Managers API Validation
  ...
  Scenario: GET Support Managers returns successful response with required fields
    When I send a GET request to endpoint "getSupportManagers"
  ...
  Scenario: GET Support Managers response has valid data structure
    When I send a GET request to endpoint "getSupportManagers"
    Then the response status should be 200
  ...
  Scenario: GET Support Managers response fields have non-empty values
    When I send a GET request to endpoint "getSupportManagers"
    Then the response status should be 200
  ...
  Scenario: GET Support Managers response has valid email format
    When I send a GET request to endpoint "getSupportManagers"
    Then the response status should be 200
