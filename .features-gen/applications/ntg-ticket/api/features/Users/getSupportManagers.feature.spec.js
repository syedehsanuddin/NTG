...
test.describe("Support Managers API Validation", () => {
  ...
  test("GET Support Managers returns successful response with required fields", { tag: ["@getSupportManagers"] }, async ({ When, request, Then, And }) => {
  ...
  test("GET Support Managers response has valid data structure", { tag: ["@getSupportManagers"] }, async ({ When, request, Then, And }) => {
    await When("I send a GET request to endpoint \"getSupportManagers\"", null, { request });
    await Then("the response status should be 200");
  ...
  test("GET Support Managers response fields have non-empty values", { tag: ["@getSupportManagers"] }, async ({ When, request, Then, And }) => {
    await When("I send a GET request to endpoint \"getSupportManagers\"", null, { request });
    await Then("the response status should be 200");
  ...
  test("GET Support Managers response has valid email format", { tag: ["@getSupportManagers"] }, async ({ When, request, Then, And }) => {
    await When("I send a GET request to endpoint \"getSupportManagers\"", null, { request });
    await Then("the response status should be 200");
...
const bddFileMeta = {
  "GET Support Managers returns successful response with required fields": {"pickleLocation":"5:3","tags":["@getSupportManagers"]},
  "GET Support Managers response has valid data structure": {"pickleLocation":"15:3","tags":["@getSupportManagers"]},
  "GET Support Managers response fields have non-empty values": {"pickleLocation":"24:3","tags":["@getSupportManagers"]},
  "GET Support Managers response has valid email format": {"pickleLocation":"31:3","tags":["@getSupportManagers"]},
};