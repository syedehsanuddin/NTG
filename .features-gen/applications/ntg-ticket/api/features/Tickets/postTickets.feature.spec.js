...
test.describe("Create Ticket API Validation", () => {
  ...
  test("POST Ticket with valid payload returns successful response", { tag: ["@postTicket", "@zeeshan123"] }, async ({ When, request, Then, And }) => {
...
const bddFileMeta = {
  "POST Ticket with valid payload returns successful response": {"pickleLocation":"5:3","tags":["@postTicket","@zeeshan123"],"ownTags":["@zeeshan123"]},
