...
test.describe("Get Tickets API Validation", () => {
  ...
  test("GET Tickets returns successful response with default parameters", { tag: ["@getTickets"] }, async ({ When, request, Then, And }) => {
  ...
  test("GET Tickets with page and limit returns paged results", { tag: ["@getTickets"] }, async ({ When, request, Then, And }) => {
  ...
  test("GET Tickets with priority filter returns matching tickets", { tag: ["@getTickets"] }, async ({ When, request, Then, And }) => {
  ...
  test("GET Tickets with search parameter returns matching tickets", { tag: ["@getTickets"] }, async ({ When, request, Then, And }) => {
  ...
  test("GET Tickets with date range returns tickets in date range", { tag: ["@getTickets"] }, async ({ When, request, Then, And }) => {
...
const bddFileMeta = {
  "GET Tickets returns successful response with default parameters": {"pickleLocation":"6:3","tags":["@getTickets"]},
  "GET Tickets with page and limit returns paged results": {"pickleLocation":"13:3","tags":["@getTickets"]},
  "GET Tickets with priority filter returns matching tickets": {"pickleLocation":"21:3","tags":["@getTickets"]},
  "GET Tickets with search parameter returns matching tickets": {"pickleLocation":"27:3","tags":["@getTickets"]},
  "GET Tickets with date range returns tickets in date range": {"pickleLocation":"33:3","tags":["@getTickets"]},
};