...
test.describe("Get Tickets API Validation", () => {
  ...
  test("GET Tickets returns successful response with default parameters", { tag: ["@getTickets", "@happyflow", "@regression"] }, async ({ When, request, Then, And }) => {
...
const bddFileMeta = {
  "GET Tickets returns successful response with default parameters": {"pickleLocation":"6:3","tags":["@getTickets","@happyflow","@regression"]},
