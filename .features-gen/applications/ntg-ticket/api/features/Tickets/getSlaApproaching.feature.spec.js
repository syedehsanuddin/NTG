...
test.describe("Get SLA Approaching Tickets API Validation", () => {
  ...
  test("GET SLA Approaching Tickets returns successful response", { tag: ["@getSlaApproaching"] }, async ({ When, request, Then, And }) => {
...
const bddFileMeta = {
  "GET SLA Approaching Tickets returns successful response": {"pickleLocation":"6:3","tags":["@getSlaApproaching"]},
};