...
test.describe("Create Comment API Validation", () => {
  ...
  test("POST Comment for a newly created ticket returns successful response", { tag: ["@postComment", "@happyflow"] }, async ({ When, request, Then, And }) => {
...
const bddFileMeta = {
  "POST Comment for a newly created ticket returns successful response": {"pickleLocation":"5:3","tags":["@postComment","@happyflow"]},
};