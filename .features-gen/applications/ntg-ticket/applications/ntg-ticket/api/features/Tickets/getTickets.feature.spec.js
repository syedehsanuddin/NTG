...
test.describe("Get Tickets API Validation", () => {
  ...
  test("GET Tickets returns successful response with default parameters", async ({ When, request, Then, And }) => {
  ...
  test("GET Tickets with page and limit returns paged results", async ({ When, request, Then, And }) => {
  ...
  test("GET Tickets with priority filter returns matching tickets", async ({ When, request, Then, And }) => {
  ...
  test("GET Tickets with search parameter returns matching tickets", async ({ When, request, Then, And }) => {
  ...
  test("GET Tickets with date range returns tickets in date range", async ({ When, request, Then, And }) => {
...
const bddFileMeta = {
  "GET Tickets returns successful response with default parameters": {"pickleLocation":"6:3"},
  "GET Tickets with page and limit returns paged results": {"pickleLocation":"13:3"},
  "GET Tickets with priority filter returns matching tickets": {"pickleLocation":"21:3"},
  "GET Tickets with search parameter returns matching tickets": {"pickleLocation":"27:3"},
  "GET Tickets with date range returns tickets in date range": {"pickleLocation":"33:3"},
};