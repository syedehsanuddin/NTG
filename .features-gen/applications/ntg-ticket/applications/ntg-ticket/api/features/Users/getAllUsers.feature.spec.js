...
test.describe("All Users API Validation", () => {
  ...
  test("GET All Users with limit returns exact number of records", async ({ When, request, Then, And }) => {
  ...
  test("GET All Users with search filter returns matching users", async ({ When, request, Then, And }) => {
  ...
  test("GET All Users with role filter returns only that role", async ({ When, request, Then, And }) => {
  ...
  test("GET All Users with isActive true returns only active users", async ({ When, request, Then, And }) => {
  ...
  test("GET All Users with page and limit returns paged data", async ({ When, request, Then, And }) => {
...
const bddFileMeta = {
  "GET All Users with limit returns exact number of records": {"pickleLocation":"6:3"},
  "GET All Users with search filter returns matching users": {"pickleLocation":"13:3"},
  "GET All Users with role filter returns only that role": {"pickleLocation":"21:3"},
  "GET All Users with isActive true returns only active users": {"pickleLocation":"29:3"},
  "GET All Users with page and limit returns paged data": {"pickleLocation":"37:3"},
};