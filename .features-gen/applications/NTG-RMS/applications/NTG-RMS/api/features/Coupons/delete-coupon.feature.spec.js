...
test.describe("Delete coupon (soft delete)", () => {
  ...
  test("POST Create a new coupon returns successful response", { tag: ["@deleteCoupon", "@happyFlow"] }, async ({ When, request, Then, And }) => {
  ...
  test("DELETE Delete coupon (soft delete) returns successful response", { tag: ["@deleteCoupon", "@happyFlow"] }, async ({ When, request, Then }) => {
...
const bddFileMeta = {
  "POST Create a new coupon returns successful response": {"pickleLocation":"7:3","tags":["@deleteCoupon","@happyFlow"]},
  "DELETE Delete coupon (soft delete) returns successful response": {"pickleLocation":"13:3","tags":["@deleteCoupon","@happyFlow"]},
};