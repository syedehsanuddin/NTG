...
test.describe("Get all customers", () => {
  ...
  test("GET Get all customers returns successful response", { tag: ["@getCustomersExplicit"] }, async ({ When, request, Then, And }) => {
...
const bddFileMeta = {
  "GET Get all customers returns successful response": {"pickleLocation":"6:3","tags":["@getCustomersExplicit"]},
};