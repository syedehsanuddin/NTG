...
test.describe("Create a new customer", () => {
  ...
  test("POST Create a new customer returns successful response", { tag: ["@postCreateCustomerExplicit", "@ahsan133", "@happyFlow"] }, async ({ When, request, Then }) => {
...
const bddFileMeta = {
  "POST Create a new customer returns successful response": {"pickleLocation":"6:3","tags":["@postCreateCustomerExplicit","@ahsan133","@happyFlow"]},
};