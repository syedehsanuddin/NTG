...
const bddFileMeta = {
  "POST Create a new employee returns successful response": {"pickleLocation":"6:5","tags":["@deleteEmployee"]},
  "DELETE Delete an employee (soft delete) returns successful response": {"pickleLocation":"11:3","tags":["@deleteEmployee"]},
};