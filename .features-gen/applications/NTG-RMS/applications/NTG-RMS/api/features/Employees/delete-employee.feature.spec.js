...
test.describe("Delete an employee (soft delete)", () => {
  ...
  test("POST Create a new employee returns successful response", { tag: ["@deleteEmployee", "@happyFlow", "@ahsan12344"] }, async ({ When, request, Then, And }) => {
...
const bddFileMeta = {
  "POST Create a new employee returns successful response": {"pickleLocation":"7:5","tags":["@deleteEmployee","@happyFlow","@ahsan12344"],"ownTags":["@ahsan12344"]},
  "DELETE Delete an employee (soft delete) returns successful response": {"pickleLocation":"12:3","tags":["@deleteEmployee","@happyFlow"]},
};