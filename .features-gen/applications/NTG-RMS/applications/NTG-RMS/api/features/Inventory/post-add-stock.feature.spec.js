...
test.describe("Add stock (Purchase Entry)", () => {
  ...
  test("POST Create a new ingredient returns successful response", async ({ When, request, Then, And }) => {
  ...
  test("POST Add stock (Purchase Entry) returns successful response", async ({ When, request, Then }) => {
...
const bddFileMeta = {
  "POST Create a new ingredient returns successful response": {"pickleLocation":"7:3"},
  "POST Add stock (Purchase Entry) returns successful response": {"pickleLocation":"14:3"},
};